CREATE TABLE group_invitations (
    ...
    invited_email member_email_address NOT NULL,
    invited_by member_email_address NOT NULL REFERENCES members (email),
    invited_at TIMESTAMPTZ NOT NULL,
    accepted_by member_email_address NULL REFERENCES members (email),
